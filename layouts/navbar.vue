<template>
      ...
      <Menubar :model="items" :pt="ptMenuBar" class="pt-5">
        <template #start>
          <a href="/" class="flex items-center gap-1">
            ...
            <img
              ...
              alt="logo"
              class="h-8 w-auto rounded-md pr-3"
            />
          </a>
        </template>
        ...
        <template #end>
          <div class="flex items-center gap-4">
            ...
            <Button
              v-if="session?.user"
              class="cursor-pointer text-prime-vue-error bg-red-100 border-0 hover:!bg-red-500 active:!bg-red-800 hover:!border-0 p-2 rounded-lg px-4"
              @click="logout"
              >Logout</Button
            >
          </div>
  ...
  <footer class="bg-gray-100 text-gray-800 mt-20 w-full">
    <div class="w-full px-6 py-16">
      ...
      <div
        class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12"
      >
        <!-- Logo et description -->
        <div class="lg:col-span-1">
          ...
          <p class="text-gray-600 mb-6 leading-relaxed">
            La plateforme qui connecte entreprises et freelances qualifiés dans
            tous les domaines du digital.
          </p>
...
// Calculer les items du menu en fonction de l'état de connexion
const items = computed(() => {
  ...
  // Ajouter les items pour les utilisateurs connectés
